...
//Coded into the FPGA fabric, cannot be instatiated like Block Ram
...
module rom_with_file(
    ...
    initial
        $readmemb("truth_table.mem", rom); //Reads a binary file of memory called truth_table.mem and puts it into the rom
